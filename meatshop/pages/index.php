...
<head>
    ...
    <style>
        ...
        /* Adjustments to the footer, so everything is centered */
        footer {
            text-align: center;
            padding: 10px;
            color: #fff;
    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        ...
        <div class="grid mt-6">
            ...
            <a href="products.php" class="card">
                <i class="ph ph-package text-red-600"></i>
                <div>
            ...
            <a href="reservations.php" class="card">
                <i class="ph ph-list-checks text-green-600"></i>
                <div>
                    <h2>Reservations</h2>
            ...
            <a href="settings.php" class="card">
                <i class="ph ph-gear text-yellow-600"></i>
                <div>
        ...
        <div class="mt-6 bg-white p-6 rounded-lg shadow-md">
            <h2 class="text-2xl font-semibold text-gray-800">Trend Products</h2>
