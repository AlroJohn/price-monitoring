...
<body class="bg-gray-100">
    ...
    <div class="max-w-4xl mx-auto mt-10 p-6 bg-white shadow-lg rounded-lg relative">
        <div class="flex justify-between items-center border-b pb-4">
            <h2 class="text-2xl font-semibold text-gray-800">Settings</h2>
            <button type="button"
                class="text-blue-500 text-xl hover:text-blue-700 edit-btn border px-3 py-1 border-blue-500 rounded-md">
        ...
        <div class="flex border-b mb-6">
            ...
            foreach ($tabs as $key => [$label, $icon]) {
                $active = $current_tab === $key ? "border-b-4 border-red-500 font-bold text-red-600" : "text-gray-600";
        ...
        <?php if ($current_tab === 'owner'): ?>
            <div>
                <form method="POST" class="mt-4 space-y-3">
                    ...
                    <button type="submit" name="update_owner"
                        class="bg-red-500 text-white px-4 py-2 rounded save-btn hidden">Save</button>
                    <button type="button" class="bg-gray-400 text-white px-4 py-2 rounded cancel-btn hidden">Cancel</button>
                </form>
            </div>
        <?php endif; ?>
        ...
        <?php if ($current_tab === 'store'): ?>
            <div>
                <form method="POST" enctype="multipart/form-data" class="mt-4 space-y-3">
                    ...
                    <!-- Fetch and Display Editable Address Fields -->
                    <?php
