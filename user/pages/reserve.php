    ...
    <div class="max-w-lg mx-auto my-10 p-6 bg-white rounded-lg shadow-xl">
        ...
        <form method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="number" id="quantity" name="quantity" required min="1" max="<?php echo $product['QTY_STOCK']; ?>" class="w-full border-2 border-gray-300 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 transition duration-300 ease-in-out" oninput="updateTotalPrice()">
            </div>
        ...
        <a href="store.php?shop_id=<?php echo $shop_id; ?>" class="block text-center text-indigo-600 mt-6 hover:underline">
